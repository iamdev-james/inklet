  ...
  return (
    <div ref={stageRef} aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      <motion.div style={{ x: driftX, y: driftY, scale: zoom }} className="absolute -inset-6">
        <Float className="top-[9%] left-[8%] hidden lg:block" duration={8} delay={0.9} reduced={reduced}>
          <div className="clay flex h-24 w-24 -rotate-3 items-center justify-center rounded-3xl">
            <span className="engraved text-5xl font-black">✳</span>
          </div>
        </Float>

        <Float className="top-[23%] left-[3%] hidden lg:block" duration={10} delay={1.6} reduced={reduced}>
          <div className="clay relative h-52 w-52 rounded-full">
            ...
            <span className="absolute top-8 left-20 h-1.5 w-1.5 rounded-full bg-accent/80" />
            <span className="absolute top-18 right-10 h-1.5 w-1.5 rounded-full bg-positive/80" />
            <span className="absolute bottom-12 left-14 h-1.5 w-1.5 rounded-full bg-[#8b7cf6]/80" />
            <span className="absolute right-16 bottom-18 h-1.5 w-1.5 rounded-full bg-[#f2c14e]/80" />
          </div>
        </Float>

        <Float className="bottom-[6%] left-[6%] hidden md:block" duration={9.5} delay={0.3} reduced={reduced}>
          <div className="clay relative h-104 w-60 rotate-2 rounded-[2.4rem] p-3">
        ...
        <Float className="top-[13%] right-[5%] hidden lg:block" duration={8} reduced={reduced}>
          <div className="clay flex h-11 w-64 rotate-2 items-center gap-2 rounded-xl px-3">
        ...
        <Float className="top-[26%] right-[8%] hidden lg:block" duration={8.5} delay={2} reduced={reduced}>
          <div className="clay flex -rotate-2 items-center gap-2 rounded-full px-4 py-2.5">
        ...
        <Float className="top-[40%] right-[7%] hidden md:block" duration={9} delay={1.2} reduced={reduced}>
          <div className="clay relative h-40 w-32 -rotate-3 rounded-3xl">
        ...
        <Float className="top-[62%] right-[4%] hidden xl:block" duration={7} delay={2.4} reduced={reduced}>
          <div className="flex rotate-3 gap-2">
            <div className="clay flex h-14 w-14 items-center justify-center rounded-xl">
              <span className="engraved text-lg font-bold">⌘</span>
            </div>
            <div className="clay relative flex h-14 w-14 items-center justify-center rounded-xl">
        ...
        <Float className="bottom-[8%] right-[6%] hidden md:block" duration={7.5} delay={0.6} reduced={reduced}>
          <div className="clay relative h-40 w-56 rotate-2 rounded-2xl">
